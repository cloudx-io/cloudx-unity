...
/*
 * Arbiter/TPA interstitial. Shared flow lives in ArbiterFullscreenController;
 * this class only supplies the interstitial SDK calls for each side.
 */
public sealed class ArbiterInterstitialController : ArbiterFullscreenController
{
    ...
    protected override string AdMobAdSourceName() => AdSourceName(_adMobInterstitial?.GetResponseInfo());
